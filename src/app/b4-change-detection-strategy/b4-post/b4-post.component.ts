import { AfterContentChecked, AfterContentInit, AfterViewChecked, AfterViewInit, Component, DoCheck, OnChanges, OnDestroy, OnInit, SimpleChanges, EventEmitter, Input, Output, ChangeDetectionStrategy } from '@angular/core';
import { Post } from '../../b1-elements-transfer/b1-main/b1-main.component';            /* Импортируем тип данных Post */
...
export class B4PostComponent implements 
OnInit, 
OnChanges,
DoCheck,
AfterContentInit,
